Class('JooseIt.Control.NavigationButton', {
    ...
    methods : {
        ...
        scale   : function (scaleFactor, scaleTime, scaleEasing) {
            this.self.animate({ scale : scaleFactor || this.scaleFactor }, scaleTime || this.scaleTime, scaleEasing || this.scaleEasing)
        },
        
        
        backscale : function (scaleFactor, scaleTime, scaleEasing) {
            this.self.animate({ scale : scaleFactor || 1 / this.scaleFactor }, scaleTime || this.scaleTime, scaleEasing || this.scaleEasing)
        },
        
        
        restoreScale : function (scaleFactor, scaleTime, scaleEasing) {
            this.self.animate({ scale : 1 }, scaleTime || this.scaleTime, scaleEasing || this.scaleEasing)
        },
