...
//            use : [ 'JooseIt.Layout.Site', 'JooseIt.Home' ],
            
            realize : function (route) {
                var params  = route.getParams()
                var root    = route.getRoot()
                
                root.activate('JooseIt.Layout.Site').slot('.center').activate('JooseIt.Home')
            } 
...
//            use : [ 'JooseIt.Layout.Site', 'JooseIt.Pictures.All' ],
            
            realize : function (route) {
                var params  = route.getParams()
                var root    = route.getRoot()
                
                root.activate('JooseIt.Layout.Site').slot('center').activate('JooseIt.Pictures.All', {
        ...
        '/picture/:id' : {
            ...
            realize : function (route) {
                ...
                root.activate('JooseIt.Layout.Site').slot('center').activate('JooseIt.Picture', {
                    id : params.id
                })
            }
        }
...
//        use : [ 'JooseIt.Layout.FullScreen', 'JooseIt.NotFound' ],
        
        realize : function (route) {
            var params  = route.getParams()
            var root    = route.getRoot()
            
            root.activate('JooseIt.Layout.FullScreen').activate('JooseIt.NotFound')
        }
    }
