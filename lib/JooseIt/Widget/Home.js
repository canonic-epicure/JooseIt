    ...
    have : {
        ...
        templateSources         : {
            /*tj:../../../content/Home.html
                ...
                <p>Joose is based in large part on the [Moose][1] system, which in turn borrows a lot of from Perl 6 object system, as well as drawing on the best ideas from CLOS, Smalltalk, and many other languages.</p>
                ...
                <p>But if you want to digg about in the guts, Joose lets you do that too, by using and extending its powerful introspection API or by providing your own meta class implementation.</p>
            tj*/
