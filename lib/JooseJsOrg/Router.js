Class('JooseJsOrg.Router', {
    ...
    my : {
        ...
        routes : [
            {
                'default' : '/JooseJsOrg.Layout.Site/JooseJsOrg.Home'
            },
            
            {
                '/pictures/all/:fromDate/:toDate' : '/JooseJsOrg.Layout.Site/.center/JooseJsOrg.Pictures.All($params)'
            }
        ]
    }
    
//    body : function (JooseJsOrgRouter) {
//        var router = JooseJsOrgRouter.my
//    }
